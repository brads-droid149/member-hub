...
-- ============================================================================
-- This file is applied automatically by `supabase db reset` against the LOCAL
-- Supabase instance only. It is NOT part of the migration chain and is NEVER
-- pushed to production by `supabase db push`.
--
-- Creates 20 fake surf-club members with the shared password "TestPassword123!"
-- so developers can exercise the member list, giveaway draws, and CSV exports
-- without needing real signups.
-- ============================================================================
