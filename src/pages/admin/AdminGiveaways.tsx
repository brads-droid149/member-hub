    ...
    img.onload = () => {
      ...
      if (!ratioOk) {
        toast({
          ...
          description: `Image must be 4:5 portrait ratio (e.g. 1080×1350px). Yours is ${img.width}×${img.height}.`,
          variant: "destructive",
        });
        ...
        <CardContent>
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label>Prize Image (JPG or PNG, 4:5 portrait, min 1080×1350px)</Label>
