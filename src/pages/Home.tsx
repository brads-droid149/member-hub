...
export default function Home() {
  ...
  // Shared state (loaded on mount — used for greeting + banners)
  const [userId, setUserId] = useState<string | null>(null);
  const [authName, setAuthName] = useState<string | null>(null);
  const [profile, setProfile] = useState<{ full_name: string | null; phone: string | null; state: string | null } | null>(null);
